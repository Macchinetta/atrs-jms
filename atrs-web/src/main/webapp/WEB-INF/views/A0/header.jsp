  ...
  <ul class="main-menu">
    ...
    <security:authorize url="/HistoryReport/">
      <li class="off" onmouseover="this.className='on'" onmouseout="this.className='off'">
        ...
        <ol class="sub-menu">
          <li class="off2" onmouseover="this.className='on2'" onmouseout="this.className='off2'">
            <a href="${pageContext.request.contextPath}/HistoryReport/create?form">履歴レポート作成</a>
          </li>
          <li class="off2" onmouseover="this.className='on2'" onmouseout="this.className='off2'">
            <a href="${pageContext.request.contextPath}/HistoryReport/download?reportList">履歴レポートDL</a>
          </li>
        </ol>
      </li>
    </security:authorize>
